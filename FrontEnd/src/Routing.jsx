...
const Routing = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <aside className="fixed right-0 top-[50%] z-40 flex -translate-y-1/2 flex-col gap-2 pr-2">
        <a
          href="#"
          aria-label="Facebook"
          className="flex h-9 w-9 items-center justify-center rounded-full bg-[#043ea4] text-white transition-transform hover:scale-110"
        >
