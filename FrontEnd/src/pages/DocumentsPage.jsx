            ...
            <div className="max-w-5xl mx-auto space-y-12">
                {Object.keys(documents).length === 0 ? (
                    <div className="text-center py-20">
                        <p className="text-slate-400 font-bold uppercase tracking-widest text-sm">No documents published yet.</p>
                    </div>
                ) : (
                    Object.entries(documents).map(([category, docs]) => (
                        <div key={category} className="bg-white rounded-[32px] shadow-2xl shadow-slate-200/50 overflow-hidden border border-slate-100 transform transition-all hover:scale-[1.01]">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <h3 className="text-xl font-black text-slate-800">
                                            {category.includes('IIC') ? 'IIC Document' : 'Documents'}
                                        </h3>
                                    </div>
                                        ...
                                        {docs.map((doc) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span className="text-xs font-black text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity uppercase tracking-widest">Open PDF</span>
